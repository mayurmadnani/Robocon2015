...
namespace Robocon2015
{
    public partial class Match3 : Form
    {
        ...
        public Match3(String r, String b, String rs, String bs, String rs1, String bs1, String m, String round)
        {
            InitializeComponent();
            redteam = r;
            blueteam = b;
            ...
            lbl_redScore1.Text = rs1;
            lbl_blueScore1.Text = bs1;
        }
        ...
        {
            lbl_redScore2.Text = "";
            lbl_redScore2.Text = txt_red.Text;
            lbl_blueScore2.Text = "";
            lbl_blueScore2.Text = txt_blue.Text;
        }
